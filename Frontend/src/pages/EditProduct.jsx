...
const EditProduct = () => {
  ...
  const addVariant = () => {
    setVariants([
      ...variants,
      { size: "", color: "", sku: "", stock: 0, price: 0, images: [], existingImages: [] },
    ]);
  };
  ...
  const removeExistingVariantImage = (vIndex, iIndex) => {
    const newVariants = [...variants];
    newVariants[vIndex].existingImages = newVariants[vIndex].existingImages.filter(
      (_, i) => i !== iIndex,
    );
    setVariants(newVariants);
  };
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      await apiRequest.patch(`/products/${productId}`, data, {
        headers: {
      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="flex items-center gap-3 mb-8">
          ...
          <div>
            ...
            <p className="text-slate-500 mt-1 font-medium">Update product details and inventory</p>
          </div>
        </div>
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 md:grid-cols-5 gap-4 mb-4">
              {existingImages.map((img, index) => (
                ...
                >
                  ...
                  <div className="absolute bottom-2 left-2 px-2 py-0.5 bg-indigo-600 text-[10px] font-bold text-white rounded-md">EXISTING</div>
                </div>
              ))}
              ...
              {images.map((img, index) => (
                ...
                >
                  ...
                  <div className="absolute bottom-2 left-2 px-2 py-0.5 bg-green-600 text-[10px] font-bold text-white rounded-md">NEW</div>
                </div>
              ))}
                    ...
                    <div className="flex flex-wrap gap-3">
                      {variant.existingImages?.map((img, iIndex) => (
                        ...
                        >
                          ...
                          <button
                            type="button"
                            onClick={() => removeExistingVariantImage(vIndex, iIndex)}
